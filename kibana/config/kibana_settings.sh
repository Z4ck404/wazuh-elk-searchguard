...
## Adding SearchGuard suff 
#echo "xpack.security.enabled: false" >> /usr/share/kibana/config/kibana.yml
echo "elasticsearch.username: kibanaserver" >> /usr/share/kibana/config/kibana.yml
echo "elasticsearch.password: kibanaserver" >> /usr/share/kibana/config/kibana.yml
echo "searchguard.cookie.password: 123567818187654rwrwfsfshdhdhtegdhfzftdhncn" >> /usr/share/kibana/config/kibana.yml
